...
public class ContaAgua {
	...
	private String periodo_consumo, estacao, cpf, dataRef;
	private Double valor, consumo_metros_cubicos;
	private Date data;

	public ContaAgua(String periodo_consumo, Double valor, Double consumo_metros_cubicos, String estacao, String cpf, String dataRef) {
